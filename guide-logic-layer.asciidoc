...
//io.oasp.application.mtsj.imagemanagement.logic.api
[source,java]
----
/**
...
----
//Doesn't exist anymore in the current version
=== Component Part Interface with Use Case Decomposition
...
//io.oasp.application.mtsj.imagemanagement.logic.impl
[source,java]
----
...
//Changed example to User since the Table doesn't exist.
[source,html]
----
  <mapping>
...
----
//Staff management doesnt exist anymore.
//draw a new class diagram with some other Management e.g. Imagemanagement/Usermanagement.
